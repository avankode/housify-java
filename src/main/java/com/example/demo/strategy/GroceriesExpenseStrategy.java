...
@Component
public class GroceriesExpenseStrategy implements ExpenseStrategy {
    @Override
    public Expense.Category getCategory() { return Expense.Category.GROCERIES; }

    @Override
    public void validate(User user, Map<String, Object> payload) {
        if (user.getHouse() == null) {
            throw new RuntimeException("You must be in a house to add shared groceries.");
        }
    }
